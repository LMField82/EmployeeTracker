...
const mainMenu = () => {
    inquirer.prompt ([

     {
        ...
        choices: ["View Employees", "View Departments", "View Roles", "Add Employee", "Add Department", "Add Role","Delete Employee", "Delete Department", "Delete Role", "Update Employee Roles", "Exit"]
     }
  ]).then(answer => {
